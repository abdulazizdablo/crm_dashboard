        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control {{ $errors->has('contact_email') ? 'is-invalid' : '' }}" rows="10" name="description"
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('project_id') ? 'is-invalid' : '' }}" name="project_id"
